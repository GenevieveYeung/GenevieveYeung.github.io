...
export const featuredProjects = [
  ...
  {
    number: "02", slug: "vgrf-koa-prediction", category: "Final year project / multimodal machine learning", title: "Smartphone-based vGRF Estimation & KOA Screening", summary: "A lightweight pipeline that estimates vertical ground reaction force (vGRF) from smartphone gait video, then uses derived gait features to support KOA screening.", result: "R² ≈ 0.96 · AUC ≈ 0.70", resultLabel: "reported results", technologies: ["PyTorch", "BlazePose", "Time series", "Deep learning"], kind: "multimodal",
  ...
  {
    number: "04", slug: "fall-detection-system", category: "Computer vision / temporal machine learning", title: "Video-based Real-time Fall Detection", summary: "A real-time fall-detection system that monitors video continuously, identifies whether a person is falling, and triggers an alert when a fall is detected.", result: "98.81% test accuracy", resultLabel: "reported result", technologies: ["MediaPipe", "1D CNN", "RNN / LSTM", "CNN-Transformer"], kind: "vision",
